    ...
    return (
        <main className=''>
            ...
            <section className={showMobileMenu ? 'hidden' : 'block'}>
                ...
                <div>
                    <div className='w-full z-40 flex flex-col h-96 -mb-28 pt-12 items-center text-center text-white bg-mediumBlue' style={{ clipPath: 'polygon(0 16%, 100% 5%, 100% 95%, 0 84%)' }}>
                    ...
                    <img alt='' className='w-full z-30' src={images['mobileHowSmile.jpg'].default} />
                </div>
            </section>
        </main>
    )
