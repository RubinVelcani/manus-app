            ...
            <section className={showMobileMenu ? 'hidden' : 'block'}>
                <div className='flex flex-col w-4/5 items-center text-center mx-auto pb-36'>
                    ...
                    <form className='w-full flex flex-col text-left text-sm text-formGray mt-4 mb-16' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {errors.message && <h3 className='text-red mb-10'>This field is required</h3>}
                        ...
                        {errors.industry && <h3 className='text-red mb-10'>This field is required</h3>}
                        ...
                        {errors.firstName && <h3 className='text-red mb-10'>This field is required</h3>}
                        ...
                        {errors.lastName && <h3 className='text-red mb-10'>This field is required</h3>}
                        ...
                        {errors.phoneNumber && <h3 className='text-red mb-10'>This field is required</h3>}
