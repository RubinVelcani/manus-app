...
const MobileStep2 = ({ togglePageThree }) => {
            ...
            <section className='w-11/12 flex flex-col items-center text-xs text-gray mx-auto py-8'>
                <div className='w-4/5 flex flex-col text-left text-formGray mt-4 mb-16 mx-auto'>
                    ...
                    <div className='flex flex-row justify-around mt-10'>
                        ...
                        <button onClick={() => { onSubmit(); togglePageThree() }} className=' w-5/12 rounded-3xl bg-lightBlue text-white ring-1 ring-mediumGray mx-auto p-2 cursor-pointer outline-none focus-within:ring-mediumBlue'>Continue </button>
                    </div>
                </div>
            </section>
        </form>
