...
const DesktopStep2 = ({ togglePageThree }) => {
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='w-4/5 flex flex-col font-medium text-formGray mt-4 mb-16 mx-auto'>
                ...
                <div className='flex flex-row mt-10'>
                    ...
                    <button onClick={() => { onSubmit(); togglePageThree() }} className=' w-1/4 rounded-3xl bg-mediumBlue text-white ring-2 ring-mediumBlue p-2 cursor-pointer focus:outline-none'>Continue</button>
                </div>
            </div>
        </form>
    )
